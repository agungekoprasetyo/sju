@extends('layouts.backend') @section('custom-css')
<!-- DataTables -->
<link href="{{
        asset(
            '/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css'
        )
    }}" rel="stylesheet" type="text/css" /><!-- Responsive datatable -->
<link href="{{
        asset(
...
@endsection @section('title-page') Users @endsection @section('content')
<div class="row">
    <div class="col-12">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary" style="background-image:url('/assets/images/bgtf.png');background-size:cover">
                <h5 class="modal-title mt-0 text-light">
                    <a id="form-act-name"></a> Users
                </h5>
            ...
            <div class="modal-body">
                <form id="frm">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="name" id="name" /><small id="name_message" class="form-text text-danger text-error"></small>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label for="email" class="col-sm-3 col-form-label">Email</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="email" id="email" /><small id="email_message" class="form-text text-danger text-error"></small>
                        </div>
                    </div>
                    <div class="form-group row mb-4">
                        <label for="password" class="col-sm-3 col-form-label">Password</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="password" id="password" /><small id="password_message" class="form-text text-danger text-error"></small>
                        </div>
                    </div>
                    <div class="form-group row justify-content-end">
                        <div class="col-sm-9">
                            <div>
                                <button type="submit" class="btn btn-primary w-md float-right">
                                    Save
                                </button>
                            </div>
                        </div>
...
<script>
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        return (
                            "<div class='custom-control custom-checkbox'><input type='checkbox' name='multiple' class='custom-control-input cb-child' id='" +
                            data +
                            "-child' value='" +
                            data +
    ...
    $("#frm").submit(function(e) {
        ...
        $.ajax({
            url: '{{ url("admin/users") }}' + "/" + form_state,
            type: "post",
            data: formData,
            ...
            error: function(xhr, ajaxOptions, thrownError) {
                Swal.fire({
                    type: "error",
                    title: "Oops...",
                    text: "Something Wrong, Problem Code " +
                        xhr.status +
