            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <h4 class="card-title mt-0">Data Categories</h4>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-primary"
                    ...
                    <h5 class="modal-title mt-0 text-light"><a id="form-act-name"></a> Categories</h5>
...
@section('custom-js')
    ...
    <script src="{{ asset('/assets/libs/datatables.net-buttons/js/buttons.colVis.min.js') }}"></script><!-- Responsive -->
    ...
    <script>
        ...
        $("#frm").submit(function(e) {
            ...
            $.ajax({
                url: '{{ url('admin/categories') }}' + '/' + form_state,
                type: 'post',
                data: formData,
