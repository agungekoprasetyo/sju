            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <h4 class="card-title mt-0">Data Menus</h4>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-primary"
                    ...
                    <h5 class="modal-title mt-0 text-light"><a id="form-act-name"></a> Menus</h5>
                    ...
                    <form id="frm" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <small id="category_id_message" class="form-text text-danger text-error"></small>
                            </div>
                        </div>

                        <div class="form-group row mb-4">
                            <label for="nama" class="col-sm-3 col-form-label">Nama</label>
                            <div class="col-sm-9"><input type="text" class="form-control" name="nama" id="nama"><small
                                    id="nama_message" class="form-text text-danger text-error"></small>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="deskripsi" class="col-sm-3 col-form-label">Deskripsi</label>
                            <div class="col-sm-9"><input type="text" class="form-control" name="deskripsi"
                                    id="deskripsi"><small id="deskripsi_message"
                                    class="form-text text-danger text-error"></small>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="harga" class="col-sm-3 col-form-label">Harga</label>
                            <div class="col-sm-9"><input type="text" class="form-control" name="harga" id="harga"><small
                                    id="harga_message" class="form-text text-danger text-error"></small>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                ...
                                <small id="image_message" class="form-text text-danger text-error"></small>
                            </div>
                        </div>
...
@section('custom-js')
    ...
    <script>
        ...
        $("#frm").submit(function(e) {
            ...
            $.ajax({
                url: '{{ url('admin/menus') }}' + '/' + form_state,
                type: 'post',
                data: formData,
