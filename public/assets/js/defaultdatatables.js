$(function() {
    ...
    $.extend($.fn.dataTable.defaults, {
        ...
        "dom": "<'row'<'col-sm-12 col-md-6'<'float-left mr-2'B><'float-left'l>><'col-sm-12 col-md-6'<'float-right'f>>>" +
            "<'row'<'col-sm-12'tr>>" +
        ...
        buttons: [{
            extend: 'collection',
            text: '<i class="fa fa-file"></i> <span class="d-none d-lg-inline-block ml-2">Export</span>',
